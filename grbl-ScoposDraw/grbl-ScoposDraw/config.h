...
// If you use a servo instead of a spindle (like on ScoposDraw plotter), you need to uncomment this option. 
...
//In this case the Y.step will be used to control the servo. 
//And therefore the Y axis is passed to the Z Axis. 
//On the other hand, the Z Axis, which is not used in the Draw is eliminated.
#define Y_IS_SERVO // Default disabled. Uncomment to enable. 
