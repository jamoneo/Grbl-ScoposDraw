...
#define cpu_map_h
 ...
 //Free Y si Y is Servo
 //And it goes to Z and Z can't be used
  #ifdef Y_IS_SERVO
  ...
  // NOTE: Only used when variable spindle is enabled.
    ...
    #define SERVO_PWM_MAX_VALUE     38  // set max pulse duration to 2.5ms
    #ifndef SERVO_PWM_MIN_VALUE
      #define SERV0_PWM_MIN_VALUE   7   // set min pulse duration to 0.5ms
    #endif
  ...
  #define SPINDLE_COMB_BIT	        COM2A1
   #define SERVO_OCR_REGISTER        OCR2B
  #define SERVO_COMB_BIT            COM2B1
  ...
  #define SERVO_PWM_BIT   3    // Uno Digital Pin 3
#endif
