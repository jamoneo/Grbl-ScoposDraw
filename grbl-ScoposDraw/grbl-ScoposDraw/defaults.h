...
/* The defaults.h file serves as a central default settings selector for different machine
 ...
 #ifdef DEFAULTS_SCOPOSDRAW
  // Grbl generic default settings. Should work across different machines.
  #define DEFAULT_X_STEPS_PER_MM 80
  #define DEFAULT_Y_STEPS_PER_MM 80
  #define DEFAULT_Z_STEPS_PER_MM 80               // por defecto el motor Tilt 5:1

  #define DEFAULT_X_MAX_RATE 21000.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 21000.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 20000.0 // mm/min
  #define DEFAULT_X_ACCELERATION  100
  #define DEFAULT_Y_ACCELERATION  100
  #define DEFAULT_Z_ACCELERATION  800
  #define DEFAULT_X_MAX_TRAVEL 165
  #define DEFAULT_Y_MAX_TRAVEL 250.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 20.0 // mm NOTE: Must be a positive value.
